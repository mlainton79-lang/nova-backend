...
async def gemini_stream(message, history, system_prompt):
    ...
    payload = {'system_instruction': {'parts': [{'text': system_prompt}]}, 'contents': contents, 'generationConfig': {'maxOutputTokens': 65536}}
